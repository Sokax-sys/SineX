...
chmod +x SineX-x64.AppImage && ./SineX-x64.AppImage
```

### Windows

Download the latest `SineX Setup *.exe` from the [Releases](https://github.com/truelockmc/streambert/releases/latest) page and run it.
...
- SineX does not host, store, or distribute any copyrighted content
