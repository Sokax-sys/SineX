...
export const storage = {
  ...
  // Remove all sinex_ keys (used by reset)
  clearAll() {
    try {
...
export async function clearAppCaches() {
  ...
  localStorage.removeItem("sinex_anilistCache");

  localStorage.removeItem("sinex_episodeGroupCache");

  localStorage.removeItem("sinex_aniskipCache");
