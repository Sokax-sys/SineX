...
export default function LibraryPage({
  ...
  const sortLabels = {
    manual: t("library.sortCustom"),
    title: t("library.sortAZ"),
  ...
  return (
    <div className="fade-in">
      ...
      {history.length > 0 && (
        <div className="library-section">
          <div className="library-section-title">{t("library.history")}</div>
                ...
                >
                  ...
                  <div style={{ flex: 1 }}>
                    ...
                    <div style={{ fontSize: 12, color: "var(--text3)" }}>
                      {item.media_type === "tv" &&
                        item.season &&
                        `${t("library.episodeTag", { season: item.season, episode: item.episode })} · `}
