...
export default function TrailerModal({ trailerKey, title, onClose }) {
  ...
  return (
    <div className={`trailer-overlay${closing ? " trailer-overlay--exit" : ""}`} onClick={handleClose}>
      <div className={`trailer-modal${closing ? " trailer-modal--exit" : ""}`} onClick={(e) => e.stopPropagation()}>
            ...
            >
              {failed ? (
                ...
                <div className="trailer-loader">
                  <div className="trailer-progress-bar" />
                  <span>{statusMsg}</span>
                </div>
              )}
            </div>
