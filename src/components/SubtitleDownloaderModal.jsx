      ...
      >
        ...
        >
                ...
                {existingSubs.map((sp) => (
                  ...
                  >
                    ...
                    {sp.source && (
                      ...
                      >
                        {sp.source === "subdl" ? t("subtitle.sourceSubdl") : t("subtitle.sourceWyzie")}
                      </span>
                    )}
                    {/* Release name */}
                    <span
          ...
          >
            ...
            >
              <option value="">{t("subtitle.allLanguages")}</option>
            ...
            {selectedSubs.length > 0 && (
              ...
              >
                {t("subtitle.nSelected", { n: selectedSubs.length })}
              </span>
            )}
          </div>
            ...
            {!wyzieApiKey && !subdlApiKey && wyzieApiKey !== null && (
              ...
              >
                ...
                {onOpenSettings && (
                  ...
                  >
                    <SettingsIcon /> {t("subtitle.openSettings")}
                  </button>
                )}
              </div>
            )}
                  ...
                  >
                    ...
                    <div style={{ flex: 1, minWidth: 0 }}>
                      ...
                      >
                        ...
                        >
                          {r.via_subdl ? t("subtitle.sourceSubdl") : t("subtitle.sourceWyzie")}
                        </span>
                        {alreadyHave && (
                          <span
                            style={{
              ...
              <>
                ...
                >
                  {downloading
                    ...
                    : selectedSubs.length > 0
                      ? t("subtitle.downloadCount", { n: selectedSubs.length })
                      : t("subtitle.selectAbove")}
                </button>
                {!dl.filePath && (
                  <span style={{ fontSize: 12, color: "var(--red)" }}>
                    {t("subtitle.noFilePath")}
                  </span>
                )}
                {dlError && (
                  <span style={{ fontSize: 12, color: "var(--red)" }}>
