...
export const CelebrationIcon = ({ size = 20 }) => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
    ...
    strokeLinejoin="round"
  >
    <polyline points="20 2 22 4 20 6 22 8 20 10" />
    <polyline points="4 14 6 16 4 18 6 20 4 22" />
    <line x1="8" y1="4" x2="10" y2="6" />
    <line x1="14" y1="18" x2="16" y2="20" />
    <polyline points="14 4 16 6 14 8 16 10 14 12" />
  </svg>
);
